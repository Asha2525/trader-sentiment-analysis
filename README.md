...
## Contents
- `trader_sentiment_analysis.ipynb` — full reproducible analysis (data cleaning, merging, EDA, charts)
- `Trader_Sentiment_Analysis_Report.docx` — written report with charts, tables, and strategic takeaways
...
To reproduce: download both CSVs into the repo root as `historical_data.csv` and `fear_greed_index.csv`, then run the notebook top to bottom.
